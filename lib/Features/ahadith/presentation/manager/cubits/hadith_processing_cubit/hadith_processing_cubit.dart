...
class HadithProcessingCubit extends Cubit<HadithProcessingState> {
  ...
  Future<void> processHadiths() async {
    ...
    try {
      // Process hadiths in the background using compute
      List<HadithEntity> processedHadiths =
          await compute(processHadithsInBackground, null);

      _allAhadith = processedHadiths;
...
// Top-level function for processing hadiths in background
Future<List<HadithEntity>> processHadithsInBackground(dynamic _) async {
  // Process the hadiths (this is the heavy computation task)
...
// Top-level function to handle the hadiths processing with an isolate
...
// Top-level isolate process function
void _isolateProcess(Map<String, dynamic> message) async {
...
// Utility function to get section number
